...
decathlon_results <- readRDS(here::here("task1_decathlon_data/raw_data/decathlon.rds"))
...
write_csv(clean_decathlon_results, here::here("task1_decathlon_data/clean_data/decatlon_clean_data.csv"))
